# A program that stores book information: Title,Author,Year and ISBN
# A user can: View all records, Search an entry,Add entry,Update entry,Delete and Close

from tkinter import *
# import backend
# you are importing the class Database from backend
...
class Window(object):
    ...
    # since we added this function to a bind, this function gets a special parameter called event
    # and the event parameter holds information abt the type of event
    # if there is an Indexerror the function will do nothing. Error is commonly generated when we click on
    # listbox
